...
import os  # for creating directories Admin/Customer if it does not exists.
...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("Micro-Finance Bank")
        p1 = PhotoImage(file='./images/bank1.png')
        window.iconphoto(True, p1)
        window.configure(background="#e2f1ff")
        window.configure(cursor="arrow")

        self.Canvas1 = tk.Canvas(window, background="#e2f1ff", bd="0", insertbackground="brown",
                                 relief="ridge",
                                 selectbackground="blue", selectforeground="brown")
        ...
        self.Button1 = tk.Button(self.Canvas1, command=self.selectEmployee, activebackground="#ececec",
                                 activeforeground="black", background="black", disabledforeground="#a3a3a3",
                                 foreground="black", bd="0", highlightbackground="#d9d9d9",
                                 highlightcolor="black", pady="0",
                                 text='''ADMIN''')
        self.Button1.configure(font="-family {Segoe UI} -size 10 -weight bold")
        self.Button1.place(relx=0.161, rely=0.583, height=22, width=87)
        ...
        self.Button2.place(relx=0.617, rely=0.583, height=22, width=87)

        self.Label1 = tk.Label(self.Canvas1, background="#e2f1ff", disabledforeground="#a3a3a3",
...
class Error:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(window, background="#d3d8dc", bd="1", disabledforeground="#a3a3a3",
    ...
    def setMessage(self, message_shown):
        Label2 = tk.Label(master, background="#f2f3f4", disabledforeground="#a3a3a3",
                          ...
                          text=message_shown)
        Label2.place(relx=0.210, rely=0.171, height=31, width=214)
...
class adminLogin:
    def __init__(self, window=None):
        ...
        global Canvas1
        Canvas1 = tk.Canvas(window, background="white", insertbackground="blue", relief="ridge",
        ...
        Label2.place(relx=0.067, rely=0.283, height=191, width=280)
        global _img0
        _img0 = tk.PhotoImage(file="./images/adminill-2.png")
        Label2.configure(image=_img0)

        self.Entry1 = tk.Entry(Canvas1, background="#e2e2e2", bd="2", disabledforeground="#a3a3a3",
        ...
        self.Entry1_1 = tk.Entry(Canvas1, show='*', background="#e2e2e2", bd="2",
        ...
        self.Button = tk.Button(Canvas1, text="Login", bd="0", width=10, background="#ffff00",
                                foreground="#00254a",
                                font="-family {Segoe UI} -size 10 -weight bold",
                                command=lambda: self.login(self.Entry1.get(), self.Entry1_1.get()))
        self.Button.place(relx=0.765, rely=0.755)

        self.Button_back = tk.Button(Canvas1, text="Back", bd="0", width=10, background="#ffff00",
                                     foreground="#00254a",
                                     font="-family {Segoe UI} -size 10 -weight bold",
                                     command=self.back)
        ...
        global admin_img
        admin_img = tk.PhotoImage(file="./images/adminill-2.png")
...
class CustomerLogin:
    def __init__(self, window=None):
        ...
        global Label2
        Label2 = tk.Label(Canvas1, background="#ffffff", disabledforeground="#a3a3a3", foreground="#000000")
        Label2.place(relx=0.067, rely=0.283, height=181, width=300)
        global _img0
    ...
    def login(self, customer_account_number, customer_PIN):
        ...
        customer_accNO = customer_account_number
        if check_credentials(customer_account_number, customer_PIN, 1, True):
            self.master.withdraw()
...
class adminMenu:
    def __init__(self, window=None):
        ...
        self.Labelframe1 = tk.LabelFrame(window, relief='groove', font="-family {Segoe UI} -size 13 -weight bold",
                                         foreground="black", text="Select your option", background="#fffffe")
        ...
        self.Button1 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 background="#00254a", bd="0", disabledforeground="#a3a3a3",
        ...
        self.Button2 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 background="black", bd="0", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 11", foreground="#00254a",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
                                 text="Create bank account", command=self.createCustomeraccount)
        ...
        self.Button6 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 background="#00254a", foreground="#00254a", bd="0",
        ...
        global Frame1
        Frame1 = tk.Frame(window, relief='groove', bd="2", background="#fffffe")
...
class CloseAccountByAdmin:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", bd="0",
                                 background="#004080", disabledforeground="#a3a3a3", foreground="#00254a",
        ...
        self.Button2 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", background="#004080",
                                 bd="0", disabledforeground="#a3a3a3", foreground="#00254a",
                                        ...
                                        if PIN.isnumeric() and PIN.__len__() == 4:
                                            if confirm_PIN == PIN:
                                                if initial_balance.isnumeric():
                                                    output_message = "Customer account successfully created!"
                                                    print(output_message)
                                                    adminMenu.printMessage_outside(output_message)
                                                else:
                                                    Error(Toplevel(self.master))
...
class deleteAdmin:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(window, activebackground="#ececec", activeforeground="brown", background="brown",
                                 bd="0", disabledforeground="#a3a3a3", foreground="#00254a",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0", text='''Back''',
                                 command=self.back)
        self.Button1.place(relx=0.243, rely=0.642, height=24, width=67)

        self.Button2 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", background="black",
                                 bd="0", disabledforeground="#a3a3a3", foreground="#00254a",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0", text='''Proceed''',
    ...
    def delete_admin(self, admin_id, password):
        if admin_id == "chisom" or admin_id == admin_idNO:
            Error(Toplevel(self.master))
...
class customerMenu:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(self.Labelframe1, command=self.selectWithdraw, activebackground="#ececec",
                                 activeforeground="#000000", background="#39a9fc", bd="0",
                                 disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 11", foreground="#00254a",
        ...
        self.Button3 = tk.Button(self.Labelframe1, command=self.exit, activebackground="#ececec",
                                 ...
                                 background="#39a9fc",
                                 bd="0", disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 11",
                                 foreground="#00254a", highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
                                 text='''Exit''')
        self.Button3.place(relx=0.667, rely=0.683, height=34, width=181, bordermode='ignore')
        ...
        self.Button6 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 background="#39a9fc", bd="0", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 11", foreground="#00254a",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
        ...
        global Frame1_1_2
        Frame1_1_2 = tk.Frame(window, relief='groove', bd="2", background="#fffffe")
...
class depositMoney:
    def __init__(self, window=None):
        ...
        window.iconphoto(True, p1)
        window.configure(bd="2")
        window.configure(background="#f2f3f4")

        self.Label1 = tk.Label(window, background="#f2f3f4", disabledforeground="#a3a3a3",
                               font="-family {Segoe UI} -size 9", foreground="#000000", bd="0",
        ...
        self.Button1 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", background="#004080",
                                 disabledforeground="#a3a3a3", bd="0", foreground="#00254a",
                                 highlightbackground="#d9d9d9", font="-family {Segoe UI} -size 9",
                                 highlightcolor="black", pady="0", text='''Proceed''',
                                 command=lambda: self.submit(self.Entry1.get()))
        self.Button1.place(relx=0.56, rely=0.598, height=24, width=67)

        self.Button2 = tk.Button(window, activebackground="#ececec", activeforeground="#000000", background="#004080",
                                 disabledforeground="#a3a3a3", bd="0", font="-family {Segoe UI} -size 9",
                                 foreground="#00254a",
                                 highlightbackground="#d9d9d9", highlightcolor="black", pady="0", text='''Back''',
                                 command=self.back)
    ...
    def submit(self, amount):
        ...
        if output == -1:
            ...
            output = "Naira" + str(amount) + " deposited successfully.\nUpdated balance : " + str(output)
...
class withdrawMoney:
    ...
    def submit(self, amount):
        ...
        if output == -1:
            ...
            output = "Naira " + str(amount) + " withdrawn successfully.\nUpdated balance : " + str(output)
            customerMenu.printMessage_outside(output)
            self.master.withdraw()
